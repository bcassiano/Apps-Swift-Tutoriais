...
class ReciboViewController: UIViewController {
    ...
    private lazy var recibos: [Recibo] = [ ]
    ...
    func mostraMenuEscolhaDeFoto() {
        let menu = UIAlertController(title: "Seleção de foto", message: "Escolha uma fota da biblioteca", preferredStyle: .actionSheet)
        ...
        menu.addAction(UIAlertAction(title: "Cacelar", style: .destructive, handler: nil))
